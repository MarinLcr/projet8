...
describe('controller', function () {
	...
	it('should show entries on start-up', function () {
		// TODO: write test
		// On créer une todo "test"
		let  todo = "test"
		// Envoie de la todo dans le model
		setUpModel([todo]);
		// Au lancemment de l'application, on initialise la view à ''
		subject.setView('');
		// On vérifie que le rendu affiche bien notre todo "test"
	...
	describe('routing', function () {
		...
		it('should show completed entries', function () {
			...
			let todo = {title: 'my todo'};
			setUpModel([todo]);
			// L'url affiche "#/completed" lorsque l'on affiche les todos actives
	...
	it('should set the "clear completed" button', function () {
		let todo = {id: 17, title: 'my todo', completed: true};
		setUpModel([todo]);
	...
	it('should highlight "Active" filter when switching to active view', function () {
		// TODO: write test
		let todo = {id: 17, title: 'my todo', completed: false};
		setUpModel([todo]);
		subject.setView('#/active');
	...
	describe('toggle all', function () {
		...
		it('should update the view', function () {
			// TODO: write test
			let todo = {id: 20, title: 'an active todo', completed: false};	
			setUpModel([todo]);																																
			subject.setView('');																			
	...
	describe('element removal', function () {
		it('should remove an entry from the model', function () {
			// TODO: write test
			let todo = {id: 20, title: 'a todo'};
			setUpModel([todo]);
			subject.setView('');
			view.trigger('itemRemove', {id: 20});
			expect(model.remove).toHaveBeenCalledWith(20, jasmine.any(Function));
	...
	describe('remove completed', function () {
		it('should remove a completed entry from the model', function () {
			...
			expect(model.remove).toHaveBeenCalledWith(17, jasmine.any(Function));
		});
	...
	describe('element complete toggle', function () {
		...
		it('should update the view', function () {
			...
			view.trigger('itemToggle', {id: 17, completed: false});

			expect(view.render).toHaveBeenCalledWith('elementComplete', {id: 17, completed: false});
		});
	});
